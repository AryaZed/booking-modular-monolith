...
public class TokenService : ITokenService
{
    ...
    public string EncodeToken(string token)
    {
        ...
        {
            _logger.LogError(ex, "Error encoding token");
            throw new InternalServerException("An error occurred while encoding the token");
        }
    }
    ...
    public string DecodeToken(string encodedToken)
    {
        ...
        {
            _logger.LogWarning(ex, "Invalid token format during decoding");
            throw new BadRequestException("Invalid token format");
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error decoding token");
            throw new InternalServerException("An error occurred while decoding the token");
        }
    }
